...
export default function RegisterPage() {
  ...
  const strength = password.length >= 8 ? 'strong' : password.length >= 6 ? 'medium' : password.length > 0 ? 'weak' : '';
  const strengthColor = { strong: '#10b981', medium: '#f59e0b', weak: '#ef4444' }[strength] || 'transparent';
  const strengthWidth = { strong: '100%', medium: '66%', weak: '33%' }[strength] || '0%';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden"
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-1/4 w-96 h-96 rounded-full blur-3xl opacity-10"
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-muted mt-1">Start your AI-powered outreach journey</p>
        </div>

        <div className="glass-card p-7" style={{ border: '1px solid rgba(124,58,237,0.2)' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="btn-primary w-full flex items-center justify-center gap-2 py-3 mt-2 mb-4"
            >
              {loading ? (
